...
module.exports = ResourceSetUpdate;
 ...
 * @param {Function} next
 */
function ResourceSetUpdate(config, req, res, next) {
  this.config = config;
 ...
 */
function ResourceSet(id, name, iconUri, type, scopes, uri) {
  this.id = id;
  this.name = name;
...
/**
 * Updates the supplied resource set
 *
 * @param done
 */
function updateResourceSet(done) {
...
/**
 * Return the id of the updated resource set.
 *
 * @param  {Function} done
 * @this   OAuth
 */
